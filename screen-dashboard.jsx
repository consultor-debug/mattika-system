  ...
  return (
    <div className="page" data-screen-label="Dashboard">
      <div className="page-head">
        <div>
          <h1 className="page-title">Buenas tardes, Mateo</h1>
          <div className="page-sub">Tienes <b style={{color:'var(--ink)', cursor:'pointer'}} onClick={() => onGoto('contracts', {status:'por-firmar'})}>7 contratos por firmar</b> y <b style={{color:'var(--warning)', cursor:'pointer'}} onClick={() => onGoto('pagos', {filter:'vencida'})}>2 cuotas vencidas</b> esta semana.</div>
        </div>
        <div className="hstack gap-8">
          <button className="btn">
            <Icon name="filter" size={14}/> Mayo 2026
          </button>
      ...
      <div className="field-group cols-4 mb-24">
        <div className="metric" onClick={() => onGoto('contracts')} style={{cursor:'pointer'}}>
          ...
          <div className="metric-delta"><Icon name="trendUp" size={12}/> +18% vs. abril</div>
        ...
        <div className="metric" onClick={() => onGoto('contracts', {status:'por-firmar'})} style={{cursor:'pointer'}}>
          ...
          <div className="metric-delta neg"><Icon name="trendUp" size={12}/> 3 con &gt; 5 días</div>
        ...
        <div className="metric" onClick={() => onGoto('pagos')} style={{cursor:'pointer'}}>
          ...
          <div className="metric-value"><span className="cur">S/</span>{fmtSoles(totalMes)}</div>
          <div className="metric-delta"><Icon name="trendUp" size={12}/> +S/ 312,000</div>
        ...
        <div className="metric" onClick={() => onGoto('pagos', {filter:'vencida'})} style={{cursor:'pointer'}}>
          ...
          <div className="metric-delta neg"><Icon name="trendDown" size={12}/> S/ 8,640 pendientes</div>
      ...
      <div style={{display:'grid', gridTemplateColumns:'2fr 1fr', gap: 20}}>
        ...
        <div className="card">
          ...
          <table className="tbl">
            ...
            <tbody>
              {CONTRATOS_RECIENTES.slice(0,6).map((c) => (
